...
\begin{overprint}
  \onslide<1-2>
  \url{http://topepo.github.io/caret/available-models.html} only gives parameter names.
  \onslide<3>
  \url{http://github.com/topepo/caret/blob/master/models/files} reveals all information.
\end{overprint}
\begin{overprint}
  \onslide<1>
  \shadowbox{\includegraphics[width=\linewidth]{assets/caret_screen_models_1.png}}
  \onslide<2>
  \shadowbox{\includegraphics[width=\linewidth]{assets/caret_screen_models_2.png}}
  \onslide<3>
  \shadowbox{\includegraphics[width=\linewidth]{assets/caret_screen_model_source.png}}
\end{overprint}
\end{frame}
